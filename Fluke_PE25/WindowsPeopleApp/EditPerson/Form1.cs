...
namespace EditPerson
{
    public partial class PersonEditForm : Form
    {
        ...
        private void HtmlElement__MouseDown( object sender, HtmlElementEventArgs e)
        {
            ...
            {
                this.htmlElement = (HtmlElement)sender;
        ...
        {
            new EditCourseForm(this.htmlElement.InnerText);
        }

        private void RemoveToolStripMenuItem__Click(object sender, EventArgs e)
        {
            this.htmlElement.InnerText = "";
            this.htmlElement.Style += "background-color:green;";
            this.htmlElement.MouseDown -= HtmlElement__MouseDown;
            this.htmlElement.MouseOver -= HtmlElement__MouseOver;
        }
