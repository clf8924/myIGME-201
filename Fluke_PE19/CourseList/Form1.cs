...
namespace CourseList
{
    public partial class CourseListForm : Form
    {
        ...
        public void PaintListView(string firstCourseCode)
        {
            ...
            foreach (KeyValuePair<string, Course> course in Globals.courses.sortedList)
            {
                ...
                lvi.SubItems[0].Text = thisCourse.courseCode;
                ...
                if (nStartEl == Globals.courses.sortedList.IndexOfKey(course.Key))
                {
        ...
        private void CourseListView__ItemActivate(object sender, EventArgs e)
        {
            ...
            courseCode = lv.FocusedItem.SubItems[0].Text;
        ...
        private void CourseListView__SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                courseCode = lv.FocusedItem.SubItems[0].Text.ToString();
