...
namespace Mandelbrot
{
    ...
    class Class1
    {
        ...
        static void Main(string[] args)
        {
            ...
            double imgCoordStart, imgCoordEnd;
            ...
            while (true)
            {
                ...
                if (double.TryParse(Console.ReadLine(), out imgCoordEnd))
                {
                    flag = true;
                }
                ...
                if (double.TryParse(Console.ReadLine(), out imgCoordStart))
                {
                    if (flag && imgCoordStart > imgCoordEnd)
                    {
            ...
            for (imagCoord = imgCoordStart; imagCoord >= imgCoordEnd; imagCoord += (imgCoordEnd - imgCoordStart) / 48)
            {
